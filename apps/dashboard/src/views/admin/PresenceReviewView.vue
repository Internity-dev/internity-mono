...
function fetchPresences(params: ListParams & Record<string, string | number | undefined>) {
  return http.get<ApiSuccess<Presence[]>>('/presences/pending-approval', { params }).then((r) => r.data)
}

const list = useListQuery<Presence>('presences-review', fetchPresences, {
  defaultSort: 'date',
